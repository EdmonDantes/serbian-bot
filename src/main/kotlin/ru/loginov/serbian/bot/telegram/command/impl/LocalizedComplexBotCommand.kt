...
abstract class LocalizedComplexBotCommand(
    ...
    override suspend fun executeWithoutSubCommands(context: BotCommandExecuteContext) {
        val localizedContext = object : ParentBotCommandExecuteContext(context) {
            ...
            override val arguments: LocalizationArgumentManager =
                    parent.arguments.withPrefix(localizedPrefix)
