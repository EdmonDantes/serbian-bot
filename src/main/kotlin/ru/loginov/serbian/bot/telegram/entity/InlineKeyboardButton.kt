...
data class InlineKeyboardButton(
         ...
         * *Optional*
         */
        @JsonProperty(value = "switch_inline_query", required = false) var switch_inline_query: String? = null,
        /**
         ...
         * *Optional*
         */
        @JsonProperty(value = "switch_inline_query_current_chat", required = false) var switch_inline_query_current_chat: String? = null,
        /**
